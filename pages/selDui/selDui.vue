<template>
	<view>
		<view class="colonn">
			...
			>
				<view class="colonn">
					<view class="type1" @click.stop="toRead(1)">A队</view>
					<view class="h-100"></view>
					<view class="type1" @click.stop="toRead(2)">B队</view>
					<view class="h-100"></view>
					<view class="type1" @click.stop="toRead(2)">C队</view>
				</view>
			</view>
